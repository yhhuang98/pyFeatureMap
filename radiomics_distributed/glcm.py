...
from . import base, cMatrices, deprecated
...
class RadiomicsGLCM(base.RadiomicsFeaturesBase):
  ...
  def _calculateCoefficients(self, voxelCoordinates=None):
    ...
    P_glcm = self._calculateMatrix(voxelCoordinates)
    ...
    # shape = (Nv, 1, 1, angles)
    ux = numpy.sum(i[None, :, :, None] * P_glcm, (1, 2), keepdims=True)
    uy = numpy.sum(j[None, :, :, None] * P_glcm, (1, 2), keepdims=True)

    # shape = (Nv, 2*Ng-1, angles)
    pxAddy = numpy.array([numpy.sum(P_glcm[:, i + j == k, :], 1) for k in kValuesSum]).transpose((1, 0, 2))
    # shape = (Nv, Ng, angles)
    pxSuby = numpy.array([numpy.sum(P_glcm[:, numpy.abs(i - j) == k, :], 1) for k in kValuesDiff]).transpose((1, 0, 2))

    # shape = (Nv, angles)
    HXY = (-1) * numpy.sum((P_glcm * numpy.log2(P_glcm + eps)), (1, 2))

    coefficients = dict()
    coefficients['P_glcm'] = P_glcm
    ...
    coefficients['symmetricalGLCM'] = self.symmetricalGLCM
    coefficients['weightingNorm'] = self.weightingNorm
    coefficients['Ng'] = self.coefficients['Ng']
    return coefficients

  @staticmethod
  def getAutocorrelationFeatureValue(coefficients):
    r"""
    **1. Autocorrelation**
    ...
    i = coefficients['i']
    j = coefficients['j']
    P_glcm = coefficients['P_glcm']
    ac = numpy.sum(P_glcm * (i * j)[None, :, :, None], (1, 2))
    return numpy.nanmean(ac, 1)

  @staticmethod
  def getJointAverageFeatureValue(coefficients):
    r"""
    **2. Joint Average**
    ...
    """
    if not coefficients['symmetricalGLCM']:
      pass
      #logger = logging.getLogger(RadiomicsGLCM.__module__)
      #logger.warning('The formula for GLCM - Joint Average assumes that the GLCM is symmetrical, but this is not the case.')
    return coefficients['ux'].mean((1, 2, 3))

  @staticmethod
  def getClusterProminenceFeatureValue(coefficients):
    r"""
    **3. Cluster Prominence**
    ...
    uy = coefficients['uy']
    P_glcm = coefficients['P_glcm']
    cp = numpy.sum((P_glcm * (((i + j)[None, :, :, None] - ux - uy) ** 4)), (1, 2))
    return numpy.nanmean(cp, 1)

  @staticmethod
  def getClusterShadeFeatureValue(coefficients):
    r"""
    **4. Cluster Shade**
    ...
    uy = coefficients['uy']
    P_glcm = coefficients['P_glcm']
    cs = numpy.sum((P_glcm * (((i + j)[None, :, :, None] - ux - uy) ** 3)), (1, 2))
    return numpy.nanmean(cs, 1)

  @staticmethod
  def getClusterTendencyFeatureValue(coefficients):
    r"""
    **5. Cluster Tendency**
    ...
    uy = coefficients['uy']
    P_glcm = coefficients['P_glcm']
    ct = numpy.sum((P_glcm * (((i + j)[None, :, :, None] - ux - uy) ** 2)), (1, 2))
    return numpy.nanmean(ct, 1)

  @staticmethod
  def getContrastFeatureValue(coefficients):
    r"""
    **6. Contrast**
    ...
    j = coefficients['j']
    P_glcm = coefficients['P_glcm']
    cont = numpy.sum((P_glcm * ((numpy.abs(i - j))[None, :, :, None] ** 2)), (1, 2))
    return numpy.nanmean(cont, 1)

  @staticmethod
  def getCorrelationFeatureValue(coefficients):
    r"""
    **7. Correlation**
    ...
    # shape = (Nv, 1, 1, angles)
    sigx = numpy.sum(P_glcm * ((i[None, :, :, None] - ux) ** 2), (1, 2), keepdims=True) ** 0.5
    # shape = (Nv, 1, 1, angles)
    sigy = numpy.sum(P_glcm * ((j[None, :, :, None] - uy) ** 2), (1, 2), keepdims=True) ** 0.5

    corm = numpy.sum(P_glcm * (i[None, :, :, None] - ux) * (j[None, :, :, None] - uy), (1, 2), keepdims=True)
    corr = corm / (sigx * sigy + eps)
    corr[sigx * sigy == 0] = 1  # Set elements that would be divided by 0 to 1.
    return numpy.nanmean(corr, (1, 2, 3))

  @staticmethod
  def getDifferenceAverageFeatureValue(coefficients):
    r"""
  ...
  @staticmethod
  def getDifferenceEntropyFeatureValue(coefficients):
    r"""
  ...
  @staticmethod
  def getDifferenceVarianceFeatureValue(coefficients):
    r"""
  ...
  @staticmethod
  @deprecated
  def getDissimilarityFeatureValue(coefficients):
    r"""
  ...
  @staticmethod
  def getJointEnergyFeatureValue(coefficients):
    r"""
    **11. Joint Energy**
    ...
    """
    P_glcm = coefficients['P_glcm']
    ene = numpy.sum((P_glcm ** 2), (1, 2))
    return numpy.nanmean(ene, 1)

  @staticmethod
  def getJointEntropyFeatureValue(coefficients):
    r"""
    **12. Joint Entropy**
    ...
    """
    ent = coefficients['HXY']
    return numpy.nanmean(ent, 1)


  @staticmethod
  @deprecated
  def getHomogeneity1FeatureValue(coefficients):
    r"""
  ...
  @staticmethod
  @deprecated
  def getHomogeneity2FeatureValue(coefficients):
    r"""
  ...
  @staticmethod
  def getImc1FeatureValue(coefficients):
    r"""
  ...
  @staticmethod
  def getImc2FeatureValue(coefficients):
    r"""
  ...
  @staticmethod
  def getIdmFeatureValue(coefficients):
    r"""
  ...
  @staticmethod
  def getMCCFeatureValue(coefficients):
    r"""
    **16. Maximal Correlation Coefficient (MCC)**
    ...
    Q = ((P_glcm[:, :, None, 0, :] * P_glcm[:, None, :, 0, :]) /  # slice: v, i, j, k, d
         (px[:, :, None, 0, :] * py[:, None, :, 0, :] + eps))  # sum over k (4th axis --> index 3)

    for gl in range(1, P_glcm.shape[1]):
      Q += ((P_glcm[:, :, None, gl, :] * P_glcm[:, None, :, gl, :]) /  # slice: v, i, j, k, d
  ...
  @staticmethod
  def getIdmnFeatureValue(coefficients):
    r"""
  ...
  @staticmethod
  def getIdFeatureValue(coefficients):
    r"""
  ...
  @staticmethod
  def getIdnFeatureValue(coefficients):
    r"""
  ...
  @staticmethod
  def getInverseVarianceFeatureValue(coefficients):
    r"""
    **20. Inverse Variance**
  ...
  @staticmethod
  def getMaximumProbabilityFeatureValue(coefficients):
    r"""
    **21. Maximum Probability**
    ...
    """
    P_glcm = coefficients['P_glcm']
    maxprob = numpy.amax(P_glcm, (1, 2))
    return numpy.nanmean(maxprob, 1)

  @staticmethod
  def getSumAverageFeatureValue(coefficients):
    r"""
    **22. Sum Average**
    ...
    # if coefficients['symmetricalGLCM']:
    #   logger = logging.getLogger(RadiomicsGLCM.__module__)
    #   logger.warning('GLCM is symmetrical, therefore Sum Average = 2 * Joint Average, only 1 needs to be calculated')
  ...
  @staticmethod
  @deprecated
  def getSumVarianceFeatureValue(coefficients):
    r"""
  ...
  @staticmethod
  def getSumEntropyFeatureValue(coefficients):
    r"""
    **23. Sum Entropy**
  ...
  @staticmethod
  def getSumSquaresFeatureValue(coefficients):
    r"""
    **24. Sum of Squares**
    ...
    if not coefficients['symmetricalGLCM']:
      pass
      #logger = logging.getLogger(RadiomicsGLCM.__module__)
      #logger.warning('The formula for GLCM - Sum of Squares assumes that the GLCM is symmetrical, but this is not the case.')
    i = coefficients['i']
    ux = coefficients['ux']
    P_glcm = coefficients['P_glcm']
    # Also known as Variance
    ss = numpy.sum((P_glcm * ((i[None, :, :, None] - ux) ** 2)), (1, 2))
