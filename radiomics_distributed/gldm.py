...
class RadiomicsGLDM(base.RadiomicsFeaturesBase):
  ...
  def _calculateCoefficients(self, voxelCoordinates=None):
    ...
    coefficients = {'P_gldm':P_gldm}
    coefficients['Nz'] = Nz

    coefficients['pd'] = pd
    coefficients['pg'] = pg

    coefficients['ivector'] = self.coefficients['grayLevels'].astype(float)
    coefficients['jvector'] = jvector

    return coefficients

  @staticmethod
  def getSmallDependenceEmphasisFeatureValue(coefficients):
    r"""
    **1. Small Dependence Emphasis (SDE)**
    ...
    Nz = coefficients['Nz']  # Nz = Np, see class docstring

    sde = numpy.sum(pd / (jvector[None, :] ** 2), 1) / Nz
    return sde

  @staticmethod
  def getLargeDependenceEmphasisFeatureValue(coefficients):
    r"""
  ...
  @staticmethod
  def getDependenceNonUniformityFeatureValue(coefficients):
    r"""
  ...
  @staticmethod
  def getDependenceNonUniformityNormalizedFeatureValue(coefficients):
    r"""
  ...
  def getGrayLevelVarianceFeatureValue(coefficients):
    ...
    **6. Gray Level Variance (GLV)**
    ...
    Nz = coefficients['Nz']
    pg = coefficients['pg'] / Nz[:, None]  # divide by Nz to get the normalized matrix
  ...
  @staticmethod
  def getDependenceVarianceFeatureValue(coefficients):
    r"""
    **7. Dependence Variance (DV)**
    ...
    jvector = coefficients['jvector']
    Nz = coefficients['Nz']
    pd = coefficients['pd'] / Nz[:, None]  # divide by Nz to get the normalized matrix
  ...
  @staticmethod
  def getDependenceEntropyFeatureValue(coefficients):
    r"""
  ...
  @staticmethod
  @deprecated
  def getDependencePercentageFeatureValue(coefficients):
    r"""
  ...
  @staticmethod
  def getLowGrayLevelEmphasisFeatureValue(coefficients):
    r"""
  ...
  @staticmethod
  def getHighGrayLevelEmphasisFeatureValue(coefficients):
    r"""
  ...
  @staticmethod
  def getSmallDependenceLowGrayLevelEmphasisFeatureValue(coefficients):
    r"""
    **11. Small Dependence Low Gray Level Emphasis (SDLGLE)**
    ...
    Nz = coefficients['Nz']
    P_gldm = coefficients['P_gldm']
    sdlgle = numpy.sum(P_gldm / ((ivector[None, :, None] ** 2) * (jvector[None, None, :] ** 2)), (1, 2)) / Nz
    return sdlgle

  @staticmethod
  def getSmallDependenceHighGrayLevelEmphasisFeatureValue(coefficients):
    r"""
    **12. Small Dependence High Gray Level Emphasis (SDHGLE)**
    ...
    Nz = coefficients['Nz']
    P_gldm = coefficients['P_gldm']
    sdhgle = numpy.sum(P_gldm * (ivector[None, :, None] ** 2) / (jvector[None, None, :] ** 2), (1, 2)) / Nz
    return sdhgle

  @staticmethod
  def getLargeDependenceLowGrayLevelEmphasisFeatureValue(coefficients):
    r"""
    **13. Large Dependence Low Gray Level Emphasis (LDLGLE)**
    ...
    Nz = coefficients['Nz']
    P_gldm = coefficients['P_gldm']
    ldlgle = numpy.sum(P_gldm * (jvector[None, None, :] ** 2) / (ivector[None, :, None] ** 2), (1, 2)) / Nz
    return ldlgle

  @staticmethod
  def getLargeDependenceHighGrayLevelEmphasisFeatureValue(coefficients):
    r"""
    **14. Large Dependence High Gray Level Emphasis (LDHGLE)**
    ...
    Nz = coefficients['Nz']
    P_gldm = coefficients['P_gldm']
    ldhgle = numpy.sum(P_gldm * ((jvector[None, None, :] ** 2) * (ivector[None, :, None] ** 2)), (1, 2)) / Nz
    return ldhgle
