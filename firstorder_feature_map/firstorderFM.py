...
first-order median 
"""
def masked_median_filter(image_arr, mask_arr, kernel_size):
    @ray.remote
    def process_unit(x_min, x_max, i, image_arr, mask_arr, kernel_size):
        slice_result = []
        for j in range(image_arr.shape[1]):
            for k in range(image_arr.shape[2]):
                if mask_arr[i, j, k] == 0:
                    ...
                    if len(kernel) == 0:
                        ...
                        slice_result.append(np.median(kernel))
...
"""
def masked_90_percentile_filter(image_arr, mask_arr, kernel_size):
    @ray.remote
    def process_unit(x_min, x_max, i, image_arr, mask_arr, kernel_size):
        slice_result = []
        for j in range(image_arr.shape[1]):
            for k in range(image_arr.shape[2]):
                if mask_arr[i, j, k] == 0:
                    ...
                    if len(kernel) == 0:
                        ...
                        slice_result.append(np.percentile(kernel, 90))
...
"""
def masked_10_percentile_filter(image_arr, mask_arr, kernel_size):
    @ray.remote
    def process_unit(x_min, x_max, i, image_arr, mask_arr, kernel_size):
        slice_result = []
        for j in range(image_arr.shape[1]):
            for k in range(image_arr.shape[2]):
                if mask_arr[i, j, k] == 0:
                    ...
                    if len(kernel) == 0:
                        ...
                        slice_result.append(np.percentile(kernel, 10))
